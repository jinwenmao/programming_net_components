...
namespace BankAccountServer
{
	...
	[Transaction]
	public class AccountManager : ContextBoundObject,IAccountManager
	{
      IAccount m_CreditAccount = new Account();
		IAccount m_DebitAccount = new Account();

		public void Transfer(int debitAccount,int creditAccount,decimal amount)
		{
         m_CreditAccount.Credit(creditAccount,amount);
         m_DebitAccount.Debit(debitAccount,amount);
		}
	}

   [Transaction]
   public class Account : ContextBoundObject,IAccount
	{
