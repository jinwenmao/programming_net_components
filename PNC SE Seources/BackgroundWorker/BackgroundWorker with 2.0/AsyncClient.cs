   ...
   public class AsyncClient : Form
   {
      ...
      public AsyncClient()
		...
		void InitializeComponent()
		{
         ...
         // m_ProgressBar
         // 
         this.m_ProgressBar.AutoSize = true;
         ...
         this.m_BackgroundWorker.ProgressChanged += new System.ComponentModel.ProgressChangedEventHandler(this.OnProgressChanged);
         this.m_BackgroundWorker.RunWorkerCompleted += new System.ComponentModel.RunWorkerCompletedEventHandler(this.OnCompleted);
         this.m_BackgroundWorker.DoWork += new System.ComponentModel.DoWorkEventHandler(this.OnDoWork);
